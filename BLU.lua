...
function self_command_custom(command)
	if command == 'JobMode' then
		if state.JobMode.value == 'AoE' then
			send_command('input //aset spellset magic;input /macro book 8;wait .1; input /macro set 1')
		else
			send_command('input //aset spellset tp;input /macro book 8;wait .1; input /macro set 2')
		end
	end
end
